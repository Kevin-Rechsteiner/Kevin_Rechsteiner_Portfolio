            ...
            <div className="max-w-6xl mx-auto w-full">
                ...
                >
                    ...
                    <p className="text-xl max-w-3xl mx-auto" style={{ color: "#4f4f4f", lineHeight: "1.8" }}>
                        Ich bin offen für Gespräche über Praktika, Ausbildungsplätze oder einfach einen Fachaustausch.
                    </p>
                </motion.div>
                ...
                <div className="grid md:grid-cols-2 gap-12 mb-16">
                    ...
                    >
                        ...
                        >
                            <p className="text-sm" style={{ color: "#4f4f4f", lineHeight: "1.6" }}>
                                <strong style={{ color: "#27AE60" }}>Status:</strong> Motiviert, lernbereit und auf der Suche nach einem professionellen Umfeld, in dem ich wachsen kann.
                            </p>
                        </motion.div>
                    </motion.div>
                    ...
                    >
                        ...
                        <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                            ...
                            <button
                                type="submit"
                                className="w-full py-3 rounded-lg font-bold transition-all hover:shadow-lg hover:scale-[1.02]"
                ...
                >
                    <p className="text-sm" style={{ color: "#828282" }}>
                        © {new Date().getFullYear()} Portfolio. Entwickelt mit Next.js & Tailwind CSS
                    </p>
                </motion.div>
            </div>
        </section>
